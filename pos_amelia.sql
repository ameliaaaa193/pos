...
CREATE DATABASE IF NOT EXISTS `pos_amelia` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `pos_amelia`;
...
-- Dumping data for table pos_amelia.item_penjualan: ~16 rows (approximately)
INSERT INTO `item_penjualan` (`id`, `penjualan_id`, `produk_id`, `kuantitas`, `harga_satuan`, `subtotal`, `created_at`, `updated_at`) VALUES
	...
	(18, 16, 11, 1, 35000, 35000, '2026-09-21 01:50:27', '2026-09-21 01:50:27'),
	(19, 17, 11, 1, 35000, 35000, '2026-09-21 01:52:50', '2026-09-21 01:52:50'),
	(20, 19, 8, 3, 20000, 60000, '2026-09-21 04:05:52', '2026-09-21 04:06:03');
...
INSERT INTO `jenis` (`id`, `nama`, `created_at`, `updated_at`) VALUES
	...
	(4, 'Pakaian', '2026-09-21 01:48:13', '2026-09-21 01:48:13');
...
CREATE TABLE IF NOT EXISTS `penjualan` (
  ...
  `uang_diterima` bigint(20) DEFAULT 0,
...
INSERT INTO `penjualan` (`id`, `user_id`, `total_pembayaran`, `metode_pembayaran`, `uang_diterima`, `kembalian`, `status`, `created_at`, `updated_at`) VALUES
	...
	(16, 2, 35000, 'CASH', 50000, 15000, 'COMPLETED', '2026-09-21 01:50:24', '2026-09-21 01:51:33'),
	(17, 2, 35000, 'CASH', 35000, 0, 'COMPLETED', '2026-09-21 01:52:47', '2026-09-21 01:54:00'),
	(19, 2, 60000, 'CASH', 0, 0, 'OPEN', '2026-09-21 03:46:19', '2026-09-21 04:06:03');
...
INSERT INTO `produk` (`id`, `user_id`, `jenis_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `created_at`, `updated_at`) VALUES
	...
	(8, 2, 3, 'products/461eL5eBnu5yOkEFSKAOnIQYwKUhNBv0r7XcGarD.jpg', 'Pink Lava', 15000, 20000, 6, '2026-09-01 07:38:19', '2026-09-21 04:06:03'),
	...
	(11, 2, 4, 'products/Htx6djTS7kdT6sYtwJa0pqiMwqKeOO2ENQzy9uEp.jpg', 'Baju Olahraga', 30000, 35000, 0, '2026-09-21 01:49:53', '2026-09-21 01:52:50');
...
-- Dumping data for table pos_amelia.sessions: ~1 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('e8gN68yn9lsHCYvSwYNwzfETGK7PZ7djGkFyTIib', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '', 1789963564);
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(2, 1, 'shintya', 'shintya@gmail.com', '2026-08-30 20:05:13', '$2y$12$NW.01xWh4lgN5.E0uBqIK.YDAVJjAIpqtXqLjK3gmBA4d0jVL//F.', 'siZxJZklDBjGoZW2PPtDic0M1raSKrNHVS73SAbLE5ZjrGUB0t2e574ZzpgF', '2026-08-30 20:05:13', '2026-09-11 04:20:07'),
