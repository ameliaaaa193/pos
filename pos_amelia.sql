...
-- Dumping data for table pos_amelia.item_penjualan: ~6 rows (approximately)
...
-- Dumping data for table pos_amelia.penjualan: ~3 rows (approximately)
INSERT INTO `penjualan` (`id`, `user_id`, `total_pembayaran`, `metode_pembayaran`, `status`, `created_at`, `updated_at`) VALUES
	...
	(4, 2, 35000, 'QRIS', 'COMPLETED', '2026-09-10 03:51:09', '2026-09-11 02:26:43'),
	(5, 2, 15000, 'CASH', 'COMPLETED', '2026-09-11 02:28:22', '2026-09-11 02:44:43'),
	(6, 2, 15000, 'CASH', 'COMPLETED', '2026-09-11 03:17:00', '2026-09-11 03:20:39'),
	(7, 2, 40000, 'CASH', 'COMPLETED', '2026-09-11 03:42:18', '2026-09-11 03:43:18'),
	(8, 2, 0, 'CASH', 'OPEN', '2026-09-11 04:09:38', '2026-09-11 04:09:38');
...
INSERT INTO `produk` (`id`, `user_id`, `jenis_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `created_at`, `updated_at`) VALUES
	...
	(4, 2, 2, 'products/F2TaA8AMluAioGXCKykX7yc1M7ztXEA7ce9IYtte.jpg', 'Bakso Mercon', 15000, 20000, 16, '2026-09-01 07:15:24', '2026-09-11 03:42:27'),
	...
	(10, 2, 2, 'products/2r2XIDdndLUK6JlXej5WG1N9a6sBFfYgAW1LnNfU.jpg', 'Mie Jebew', 10000, 15000, 4, '2026-09-01 07:39:55', '2026-09-11 02:44:33');
...
-- Dumping data for table pos_amelia.sessions: ~2 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('4hRSWSfXGjANnjjBuCG1yYs2UgGfSH65KqGy2wvW', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/154.0.0.0 Safari/537.36', '', 1789100712);
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(2, 1, 'shintya', 'shintya@gmail.com', '2026-08-30 20:05:13', '$2y$12$NW.01xWh4lgN5.E0uBqIK.YDAVJjAIpqtXqLjK3gmBA4d0jVL//F.', 'DN2xSTTfcRTHh2s6gIAfnB4bRUuMPj0iXEMgXSctOtebR70aN2houCUFky93', '2026-08-30 20:05:13', '2026-09-11 04:20:07'),
	...
	(8, 2, 'mell', 'mell@gmail.com', NULL, '$2y$12$lDCjR6qNrTStVLIO3znxp.vbK7HHfbUFLlmEk/ZP9TFKeorj1okzy', NULL, '2026-09-11 04:24:07', '2026-09-11 04:24:07');
